...
const ContactPage: React.FC = () => {
  const contactInfo = [
    {
      icon: <Mail className="w-6 h-6 text-soft-pink" />,
      title: "Email Us",
            ...
            <Card className="bg-white dark:bg-gray-800 border-0 shadow-lg">
              ...
              <CardContent>
                <form className="space-y-6">
                  ...
                  <Button className="w-full bg-deep-blue text-white hover:bg-deep-blue/90 dark:bg-soft-pink dark:text-deep-blue dark:hover:bg-soft-pink/90">
