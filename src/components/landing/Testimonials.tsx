...
const UserPhotoPlaceholder = ({ name }: { name: string }) => (
  <div className="w-20 h-20 rounded-full bg-deep-blue text-white flex items-center justify-center text-2xl font-semibold mb-4 mx-auto">
...
const Testimonials = () => {
  return (
    <section id="testimonials" className="bg-soft-pink">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {testimonialsData.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-gray-700 italic text-lg mb-4 text-center">"{testimonial.quote}"</p>
              <p className="text-deep-blue font-semibold text-right text-md">– {testimonial.name}</p>
            </div>
          ))}
        </div>
      </div>
